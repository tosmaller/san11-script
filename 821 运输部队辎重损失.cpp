...
namespace 수송부대_수송량_손실
{
	...
	/// 항목별 손실확률 설정
	const array<int> 손실확률_금 = {/*플레이어 1군단*/20, /*플레이어 위임군단*/20, /*컴퓨터*/10 };
	const array<int> 손실확률_병량 = {/*플레이어 1군단*/20, /*플레이어 위임군단*/20, /*컴퓨터*/10 };
	const array<int> 손실확률_일반병기 = {/*플레이어 1군단*/20, /*플레이어 위임군단*/20, /*컴퓨터*/10 };

	/// 손실비율 기본 설정
	const array<float> 손실비율_기본값 = {/*플레이어 1군단*/6.0f, /*플레이어 위임군단*/6.0f, /*컴퓨터*/3.0f };
	const array<float> 손실비율_최대값 = {/*플레이어 1군단*/10.00f, /*플레이어 위임군단*/10.00f, /*컴퓨터*/5.0f };
	...
	const array<float> 손실확률_최대값 = {/*플레이어 1군단*/10.00f, /*플레이어 위임군단*/10.00f, /*컴퓨터*/10.0f };
